        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="demo" class="collapse">
                    <li>
                        <a href="../admin/add_post.php">Adicionar Post</a>
                    </li>
                    <li>
                        <a href="../admin/post.php">Visualizar Posts</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="demo" class="collapse">
                    ...
                    <li>
                        <a href="#">Visualizar Usuários</a>
                    </li>
                </ul>
            </li>
            <li class="active">
                <a href="categorias.php"><i class="fa fa-fw fa-file"></i> Categorias</a>
            </li>
            <li>
