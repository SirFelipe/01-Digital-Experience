        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <p class="lead">
                  ...
                  <p><span class="glyphicon glyphicon-time"></span> Postado em <?php $dt_post = date('d-m-Y', strtotime($dt_post)); ?></p>
                  <hr>
                  <img class="img-responsive" src="img/<?php echo $img_post; ?>" alt=""> <hr>
